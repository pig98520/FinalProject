...
2.桃園機場往來地點的分布圖  
3.台灣到日本近年來旅遊人數的變化
4.日本近15年(2000-2015)來國內航班的變化  
5.日本仙台地區近15年(2000-2015)來國內航班的變化  
6.日本福島地區近15年(2000-2015)來國內航班的變化  
...
knitr::kable(arrive_num)
knitr::kable(depart_num)
knitr::kable(arrive_geo)
knitr::kable(depart_geo)
